...
# 6. ЖЕСТКАЯ ДИРЕКТИВА АВТОПОДПИСИ ПРИ СБОРКЕ (ПОЛНЫЙ АВТОМАТ)
android.release_artifact = apk
android.keystore = /content/wellcontrol.jks
android.keyalias = oilmate
android.keystoreresp = 120208
android.keypassresp = 120208

# РЕГИСТРАЦИЯ ПЕРЕХВАТЧИКА ТЕКСТА СКВАЖИНЫ ДЛЯ ANDROID INTENT
android.manifest.intent_filters = custom_intent_filters.json
