...
class BaseScreen(MDScreen):
    ...
    def trigger_modal(self, text_field, field_name_ru):
        """Инженерный метод: перехватывает нажатие на ячейку разметки 
        и открывает верхний изолированный буфер ввода."""
        if text_field.focus:
            text_field.focus = False  # Сразу гасим нижний фокус
            self.create_input_modal(field_name_ru, text_field)

    def create_input_modal(self, field_title, target_field):
        """Создает гигантское модальное окно в верхней половине экрана над клавиатурой."""
        ...
        def on_confirm(instance):
            target_field.text = modal_input.text  # Переносим текст строго в целевое поле
            modal.dismiss()
...
class CalcScreen(BaseScreen): # Экран технологических расчетов. Наследует BaseScreen, получая его адаптивный фон и фикс клавиатуры.
    def __init__(self, **kw):
        ...
        self.f_h_tvd = self.create_small_field("Глубина по вертикали (м)", "2500") # Истинная глубина скважины по вертикали (для гидростатики)
        ...
        ScrollView:
            MDBoxLayout:
                ...
                MDTextField:
                    ...
                    on_focus: root.trigger_modal(self, "Месторождение")
                MDTextField:
                    id: f_pad
                    hint_text: "Куст"
                    mode: "rectangle"
                    line_color_normal: 0.9, 0.4, 0.0, 1
                    text_color_normal: 1, 1, 1, 1
                    on_focus: root.trigger_modal(self, "Куст")
                MDTextField:
                    id: f_well
                    hint_text: "Скважина"
                    mode: "rectangle"
                    line_color_normal: 0.9, 0.4, 0.0, 1
                    text_color_normal: 1, 1, 1, 1
                    on_focus: root.trigger_modal(self, "Скважина")
                MDSeparator:
                ...
                MDBoxLayout:
                    ...
                    MDTextField:
                        ...
                        line_color_normal: 0.9, 0.4, 0.0, 1
                        text_color_normal: 1, 1, 1, 1
                        on_focus: root.trigger_modal(self, "Давление в трубах (Р труб)")
                    MDTextField:
                        id: f_p_zatr
                        hint_text: "Р затр"
                        mode: "rectangle"
                        line_color_normal: 0.9, 0.4, 0.0, 1
                        text_color_normal: 1, 1, 1, 1
                        on_focus: root.trigger_modal(self, "Затрубное давление (Р затр)")
                    MDTextField:
                        id: f_p_pl
                        hint_text: "Р пл"
                        mode: "rectangle"
                        line_color_normal: 0.9, 0.4, 0.0, 1
                        text_color_normal: 1, 1, 1, 1
                        on_focus: root.trigger_modal(self, "Пластовое давление (Р пл)")
                ...
                MDTextField:
                    ...
                    line_color_normal: 0.9, 0.4, 0.0, 1
                    text_color_normal: 1, 1, 1, 1
                    on_focus: root.trigger_modal(self, "Текущая плотность раствора")
                MDSeparator:
                    color: 0.15, 0.15, 0.15, 1
                MDLabel:
                ...
                MDTextField:
                    ...
                    line_color_normal: 0.9, 0.4, 0.0, 1
                    text_color_normal: 1, 1, 1, 1
                    on_focus: root.trigger_modal(self, "Искусственный забой")
                ...
                MDTextField:
                    ...
                    line_color_normal: 0.9, 0.4, 0.0, 1
                    text_color_normal: 1, 1, 1, 1
                    on_focus: root.trigger_modal(self, "Длина хвостовика 114")
                MDLabel:
                ...
                MDBoxLayout:
                    ...
                    MDTextField:
                        ...
                        line_color_normal: 0.9, 0.4, 0.0, 1
                        text_color_normal: 1, 1, 1, 1
                        on_focus: root.trigger_modal(self, "Интервал перфорации: Верх (кровля)")
                    MDTextField:
                        id: f_perf_bot
                        ...
                        line_color_normal: 0.9, 0.4, 0.0, 1
                        text_color_normal: 1, 1, 1, 1
                        on_focus: root.trigger_modal(self, "Интервал перфорации: Низ (подошва)")
                MDTextField:
                    id: f_d_ek
                    ...
                    line_color_normal: 0.9, 0.4, 0.0, 1
                    text_color_normal: 1, 1, 1, 1
                    on_focus: root.trigger_modal(self, "Диаметр ЭК")
                MDBoxLayout:
                    orientation: 'horizontal'
                    spacing: "10dp"
                    adaptive_height: True
                ...
                MDTextField:
                    ...
                    line_color_normal: 0.9, 0.4, 0.0, 1
                    text_color_normal: 1, 1, 1, 1
                    on_focus: root.trigger_modal(self, "Глубина спуска ГНО / воронки")
                MDSeparator:
                    color: 0.15, 0.15, 0.15, 1
                MDLabel:
                    text: "ТЕКУЩИЙ СТАТУС"
                ...
                MDTextField:
                    ...
                    line_color_normal: 0.9, 0.4, 0.0, 1
                    text_color_normal: 1, 1, 1, 1
                    on_focus: root.trigger_modal(self, "Бригада")
                MDTextField:
                    id: f_operation
                    ...
                    line_color_normal: 0.9, 0.4, 0.0, 1
                    text_color_normal: 1, 1, 1, 1
                    on_focus: root.trigger_modal(self, "Текущая операция")
                MDTextField:
                    id: f_notes
                    ...
                    multiline: True
                    max_height: "100dp"
                    on_focus: root.trigger_modal(self, "Осложнения, примечания")
                MDFloatLayout:
                    size_hint_y: None
                    height: "54dp"
                    canvas.before:
        ...
        ScrollView:
            MDBoxLayout:
                ...
                MDTextField:
                    ...
                    multiline: True
                    max_height: "100dp"
                    on_focus: root.trigger_modal(self, "Заметки, примечания")
                MDSeparator:
                    color: 0.15, 0.15, 0.15, 1
                MDBoxLayout:
                    orientation: 'horizontal'
